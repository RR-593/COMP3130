...
Macquari Uni - COMP3130 Mobile Application Development Assignment 2

## Breif

For this assignment you must build an app that includes:

    User authentication (e.g. with Firebase)
    Use of data stored in a remote database (e.g. Firebase)
    Uses at least one mobile device service: location, photos, video, audio recording
    Be able to perform CRUD (Create, Read, Update, Delete) Operations to a data entity
...
You are required to build the mobile application using Flutter. The app should at least be a good demonstration of your idea. Prioritise features that will achieve that goal. You will be graded for good programming practices such as naming conventions, project structure, documentation, look and feel, etc. You should try to test your app on at least the Android simulator and the Chrome browser devices.   Note any device incompatibilities in the README.md file.
